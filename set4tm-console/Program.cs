           ...
           if (COM8.OpenChannel(id) == true)
           {
               ...
               switch (a)
               {
                   case 1:
                      ...
                      // Console.WriteLine($"" +
                      //     $"\nЭнергия активная прямая накопленная с момента сброса по сумме тарифов:   {Esbros.Item1} (кВт*ч)" +
                       Console.WriteLine($"Энергия накопленная за прошлый месяц по сумме тарифов:      {(COM8.ReadE(id, 2, 1, 0)).Item1} (кВт*ч)");
                       Console.WriteLine($"Энергия накопленная за позапрошлые сутки по сумме тарифов:      {(COM8.ReadE(id, 2, 2, 0)).Item1} (кВт*ч)");
